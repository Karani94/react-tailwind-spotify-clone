...
import { useAudio, useFullscreen, useStartTyping, useToggle} from 'react-use';
                    ...
                    <div className='flex items-center mr-3'>
                        {!sidebar && (
                            <div className='w-14 h-14 mr-3 relative group flex-shrink-0'>
                                ...
                                className='w-6 h-6 bg-black rounded-full opacity-0 group-hover:opacity-60 hover:!opacity-100 hover:scale-[1.06] absolute top-1 right-1 flex items-center justify-center'>
